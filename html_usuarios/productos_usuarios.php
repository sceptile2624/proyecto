        ...
        <header class="header">
            <nav class="nav">
              ...
              <ul class="nav-menu">
                ...
                <li class="nav-menu-item">
                  <a href="http://www.lecortamoslospeloswebdav.com" class="nav-menu-link nav-link nav-menu-link_active">productos</a>
                </li>
              </ul>
            </nav>
          </header>
...
echo "<a href='/proyecto/html_admin/agregarcarrito.php?user=" . urlencode($user) . "&var=" . $row["id"] . "'><img src='../IMG/carrito.png' class='mini-button'></a>";
echo "</div>";
